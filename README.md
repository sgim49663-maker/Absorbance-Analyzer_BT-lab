...
1. [CSV 또는 TXT 파일 형식](#1-csv-또는-txt-파일-형식)
2. [Assay 종류](#2-assay-종류)
3. [Step-by-Step 사용 가이드](#3-step-by-step-사용-가이드)
   - [Step 1 — CSV 업로드](#step-1--csv-업로드)
   - [Step 2 — Assay 유형 선택](#step-2--assay-유형-선택)
...
4. [ELISA / Fluorescence 전용 — Standard Curve 설정](#4-elisa--fluorescence-전용--standard-curve-설정)
5. [Layout 저장 및 불러오기](#5-layout-저장-및-불러오기)
6. [계산 공식 요약](#6-계산-공식-요약)
7. [주의사항 및 Tips](#7-주의사항-및-tips)
...
## 4. ELISA / Fluorescence 전용 — Standard Curve 설정
